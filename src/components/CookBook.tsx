...
const dishTypeFilters = ['манджа', 'основно', 'предястие', 'супа', 'салата', 'закуска', 'десерт', 'гарнитура', 'сос', 'марината', 'заготовка', 'подправка', 'тест']
const dishQuicknessFilters = ['бързо', 'средно-бързо', 'средно', 'средно-бавно', 'бавно', 'много-бавно' ]
const dishHowFilters = ['лесно', 'фурна', 'тиган', 'пържене', 'варене', 'тенджера', 'тава', 'печене', 'миксер', 'запечатване', 'без пържене',  'пасатор', 'блендер' ]
